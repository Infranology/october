 ...
 *     theme override: october_breadcrumb()
 *
 *   where october is the name of your sub-theme. For example, the
...
if (theme_get_setting('october_fixed')) {
 ...
 */
function october_theme(&$existing, $type, $theme, $path) {
...
function october_preprocess_page(&$vars, $hook) {
  // For easy printing of variables.
  $vars['logo_img'] = $vars['logo'] ?
    sprintf('<img src="%s" alt="%s" />', $vars['logo'], t('Home')) :
    '';
  ...
  // Add the secondary menu links to the right sidebar.
  $vars['right'] = $vars['secondary_menu_links'] . $vars['right'];

  // Add the search box to the tools region.
  if ($vars['search_box']) {
    $vars['tools'] = '<div id="search-box">' . $vars['search_box'] . '</div>' . $vars['tools'];
  }

  // Make sure framework styles are placed above all others.
  $vars['css_alt'] = october_css_reorder($vars['css']);
  ...
  if (theme_get_setting('october_debug')) {
    $classes[] = 'show-grid';
  }
 ...
 */
function october_css_reorder($css) {
  global $theme_info;
 ...
 */
function october_menu_local_tasks() {
  $output = '';
...
function october_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function october_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function october_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function october_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
